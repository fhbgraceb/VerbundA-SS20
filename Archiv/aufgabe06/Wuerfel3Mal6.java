 ...
 * Wuerfel3Mal6: 
 * 
 * Bei diesem Spiel würfeln mehrere Personen reihum. 
 * Sieger ist die Person, die als erstes zum dritten Mal einen 6er würfelt. 
 * Dies muss nicht in aufeinanderfolgenden Runden geschehen. 
 * Würfeln mehrere Personen in derselben Runde den dritten Sechser, gibt es mehrere SiegerInnen.
 * 
...
public class Wuerfel3Mal6 
{
	...
	public static void main(String[] args) 
	{
		...
		// Für Testzwecke kann man auf das Einlesen verzichten und vorgegebene Namen verwenden.
//		namen = new String[]{"Peter", "Susi", "Max", "Karin"};

		// für jeden Spieler einen Zähler für die Sechser
		...
		} while (! fertig);		// Solange noch niemand einen Sechser gewürfelt hat

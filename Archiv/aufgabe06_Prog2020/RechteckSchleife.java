 ...
 *   
 *   Erweiterung um Schleife, so dass mehrere Berechnungen durchgeführt werden können.
 */
public class RechteckSchleife 
{
	...
	public static void main(String[] args) 
	{
		...
		do {
			...
			System.out.println("  2) Fläche berechnen");
			...
			switch (auswahl)
			{
				...
				case 3 :diagonale = rechteckDiagonale(a, b);
					...
					break;
				case 4: System.out.print("Bitte Länge von a eingeben: ");
						a = s.nextDouble();
						System.out.print("Bitte Länge von b eingeben: ");
						b = s.nextDouble();
					break;

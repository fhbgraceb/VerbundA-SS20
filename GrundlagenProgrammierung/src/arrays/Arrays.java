...
public class Arrays {
	...
	public static void main(String[] args) {
		...
		//Deklaration
				...
				System.out.println("Anzahl der Spalten des Arrays c (in Zeile 3): " + c[3].length);
...
//			mit for each Schleife
		...
		// "Unregelmäßiges" zweidimensionales Array
		int[][] u1 = new int[][]{{1, 2, 3}, {4, 5}, {6, 7, 8, 9}};

		System.out.println("Unregelmäßiges zweidimensionales Array (mit vorgegebenen Werten):");
		for(int k = 0; k < u1.length; k++) {
			for(int l = 0; l < u1[k].length; l++) {
				System.out.print(u1[k][l] + " ");
			}
			System.out.println();
		}
		
		System.out.println("Unregelmäßiges zweidimensionales Array (\"leer\"):");
		int[][] u2 = new int[3][];
		u2[0] = new int[3];
		u2[1] = new int[2];
		u2[2] = new int[4];

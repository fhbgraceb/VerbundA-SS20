...
public class b_Wuerfel3Mal6 {
	...
	/* ähnlich dem Beispiel WuerfelSpiel wird auch hier reihum gewürfelt. 
	 * Sieger ist jedoch diesmal die Person, die als erstes zum dritten Mal einen 6er würfelt. 
	 * Dies muss nicht in aufeinanderfolgenden Runden geschehen. 
	 * Würfeln mehrere Personen in derselben Runde den dritten Sechser, 
	 * gibt es mehrere SiegerInnen. Lesen Sie dabei aber Anzahl und die Namen der SpielerInnen ein.
	*/

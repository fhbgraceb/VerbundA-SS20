...
public class b_LottoAuswertung {
	 ...
	 * dass in einem Tipp keine doppelten Zahlen und nur solche von 1 bis 45 eingegeben werden. 
	 * Simulieren Sie dann mittels Zufallszahlen die Ziehung ohne Zusatzzahl (auch hier dürfen keine doppelten vorkommen). 
	 * Geben Sie abschließend für jeden Tipp die Anzahl der richtigen Zahlen aus 
	 * und ob er gewonnen hat (3, 4, 5 oder 6 Richtige; die Zusatzzahl zählt nicht) oder nicht.
	 * */
...
//		anzahlTipps = 8;
		...
		do
		{
			...
			{
				System.out.print("Wollen Sie noch einen weiteren Tipp abgeben (\"J\" f�r JA)? ");
